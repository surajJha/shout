...
--
-- Host: localhost
-- Generation Time: Jan 06, 2015 at 07:34 PM
...
(1, 'Hard Rock Cafe', 'New Night', 'Located in two prime locations of the city Andheri and Worli, Hard Rock Cafe is known for its enticing band performances and lively music environment. They have started karaoke nights every Wednesday night.', 'music karaoke ', '2014-12-25', '20:00', '23:00', 'Sharyans Audeus, Ground Floor, Opposite Yashraj Studios, Andheri Lokhandwala, Andheri West, Mumbai', 'Andheri', 0, 0, 0, 'Music', 1, 1),
(2, 'IBar', 'New Years Party', 'Located in the heart of Bandra, IBar is usually packed with sports fans. They have started their karaoke nights for every Wednesday Night. There is a shot on the house, for every singer. And in anticipation of the night to begin, there are happy hours til', 'newyears party hot', '2014-10-15', '21:00', NULL, '7/8, Gleki, ONGC Colony Building 2, Reclamation, Bandra West, Mumbai', 'Bandra', 1500, 0, 0, 'Nightlife', 2, 1),
(3, 'New Tryst', 'Vodka Crazy', 'Part of the premium tourist spot in South Mumbai, The local offers night not once, but twice a week. Tuesday being Bollywood nights followed by Thursday with English Music. They have Happy hours in anticipation of the karaoke night to begin.', 'party drinks', '2014-12-27', '21:00', NULL, 'Phoenix Mill Compound, High Street Phoenix, Senapati Bapat Marg, Lower Parel, Mumbai', 'Lower Parel', 0, 0, 0, 'Nightlife', 3, 1);
