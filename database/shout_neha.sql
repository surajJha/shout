...
--
-- Host: localhost
-- Generation Time: Jan 19, 2015 at 01:59 PM
...
(1, 'afa', 'sdfsf', 'fasf', 'fas fafa faf', 'af', 'Santacruz', 0, 0, 0, 'Culture', 1, 0),
(2, 'sfa', 'dffdsf', 'fdsa', 'ads asf asf', 'asf', 'Andheri', 0, 0, 0, 'Comedy', 1, 0),
(3, 'sdf', 'sdfs', 'sfs', 'sfd sdf sf', 'sfd', 'Andheri', 0, 0, 0, 'Food + Drinks', 1, 0),
(4, 'afs', 'sdfad', 'afdafd', 'afsa afs afs', 'af', 'Andheri', 0, 0, 0, 'Food + Drinks', 1, 0),
(5, 'sg', 'dfgsg', 'sgfs', 'sgd sgd g', 'sg', 'Goregaon', 0, 0, 0, 'Food + Drinks', 1, 0);
